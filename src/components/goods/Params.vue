       ...
       <!--警告框-->
        ...
        <el-row>
           <el-col>
             <span>选择商品分类: </span>
             <!-- options 表示要绑定的数据源-->
             <!-- v-model 表示，选中分类以后，所有被选中 的 分类 id 的数组-->
            ...
            <el-tab-pane label="动态参数" name="many">
              ...
              <el-table
               ...
               <el-table-column
                type="expand">
                  <template slot-scope="scope">
                      <el-tag :key="i" v-for="(item, i) in scope.row.attr_vals" closable @close="tagClosed(scope, i)">{{item}}</el-tag>
               ...
               <el-table-column
                 label="操作">
                 <template slot-scope="scope">
                    <el-button type="primary" size="mini" icon="el-icon-edit" @click="showEditDialog(scope)">修改</el-button>
                    <el-button type="danger" size="mini" icon="el-icon-delete" @click="removeParams(scope)">删除</el-button>
                 </template>
               </el-table-column>
              </el-table>
            </el-tab-pane>
